        ...
        <div className="container-xxl">
          <div className="row">
            ...
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6">Hno: 277 NearVill chopal, <br /> Sonipat, Haryana <br />
                  PinCode: 131103
                </address>

                  <a href="tel:+91 8264954234" className="mt-3  d-block mb-1 text-white">+91 8264954234</a>
                  <a href="mail:indvibeinfotech@gmail.com" className="mt-2  d-block mb-0 text-white">indvibeinfotech@gmail.com</a>
